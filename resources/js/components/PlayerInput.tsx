...
export const PlayerInput: FC<PlayerInputProps> = ({
    ...
    const trigger = (
        <button
            ...
            disabled={disabled}
            className={cn(
                'flex h-auto w-full items-center rounded-md border border-input bg-background px-3 py-2 shadow-xs transition-colors hover:bg-accent/10 [&:hover_[data-slot=avatar-fallback]]:bg-accent/20 [&:hover_[data-slot=avatar-fallback]]:text-foreground',
                    ...
                    {players.map((player) => {
                        ...
                        return (
                            <CommandItem
                                ...
                                className="flex items-center gap-2.5 py-2 data-[selected=true]:bg-accent/10 data-[selected=true]:text-foreground data-[selected=true]:[&_[data-slot=avatar-fallback]]:bg-accent/20 data-[selected=true]:[&_[data-slot=avatar-fallback]]:text-foreground"
                            >
